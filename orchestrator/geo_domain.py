...
# --------------------------------------------------------------------------- #
# 大范围区域 -> 经纬度框
# 有"场数据"时，大范围**不再追问**，而是直接给该区域的场分布图 + 空间描述
# --------------------------------------------------------------------------- #
# (lon_min, lon_max, lat_min, lat_max)
REGION_BOXES = {
    "台湾": (119.3, 122.2, 21.5, 25.5),
    "台湾省": (119.3, 122.2, 21.5, 25.5),
    "台湾岛": (119.3, 122.2, 21.5, 25.5),
    "台湾地区": (119.3, 122.2, 21.5, 25.5),
    "台湾沿海": (119.3, 122.2, 21.5, 25.5),
    "台湾周边": (118.5, 123.0, 21.0, 26.0),
    "台湾海峡": (117.5, 121.0, 22.5, 25.5),
    "福建": (116.8, 120.8, 23.0, 27.6),
    "福建省": (116.8, 120.8, 23.0, 27.6),
    "浙江": (119.8, 123.0, 27.0, 30.0),
    "浙江沿海": (119.8, 123.0, 27.0, 30.0),
    "广东": (114.5, 117.8, 21.5, 24.5),
    "广东沿海": (114.5, 117.8, 21.5, 24.5),
    "粤东": (114.5, 117.5, 22.0, 24.2),
    "中国沿海": (114.5, 127.5, 17.0, 29.5),
    "全国沿海": (114.5, 127.5, 17.0, 29.5),
    "东南沿海": (114.5, 123.0, 21.0, 28.0),
    "华东沿海": (117.0, 123.0, 24.0, 30.0),
    "华南沿海": (114.5, 119.0, 20.5, 25.0),
    "近海": (114.5, 127.5, 17.0, 29.5),
    "沿岸": (114.5, 127.5, 17.0, 29.5),
    "沿海地区": (114.5, 127.5, 17.0, 29.5),
    # "全场/全域"这类说法 = 整个模式域（用户想看全图时用，避免被理解成"某个地方的场"）
    "全场": (114.5, 127.5, 17.0, 29.5),
    "全域": (114.5, 127.5, 17.0, 29.5),
    "全海域": (114.5, 127.5, 17.0, 29.5),
    "全部海域": (114.5, 127.5, 17.0, 29.5),
    "整个海域": (114.5, 127.5, 17.0, 29.5),
    "整个覆盖范围": (114.5, 127.5, 17.0, 29.5),
...
def region_box(region: str) -> Optional[tuple]:
    ...
    if not r:
        return None
    for name in sorted(REGION_BOXES.keys(), key=len, reverse=True):
        if name and name in r:
