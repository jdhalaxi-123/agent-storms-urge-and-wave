...
| 【截图位置 2】需求澄清：问题说不清时，助手先问 3~5 个带选项的问题 |
| --- |
| （把截图粘贴到这里） |
|  |
|  |
...
| 【截图位置 4】生成结果：区域/精细场分布图（红星=查询地点，黑菱形=峰值） |
| --- |
| （把截图粘贴到这里） |
|  |
|  |
